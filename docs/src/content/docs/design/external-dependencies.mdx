...
Status: earlier design, 10 September 2026. The dependency categories and secret references below inform the [workflow runtime plan](/envctl/design/workflow-runtime/). Its invocation plugin contract and Plan readiness requirements supersede this note's original extensibility scope. Delivery is now scheduled in [M3](/envctl/roadmap/#m3-invocation-plugins-and-executable-plan-readiness). Examples below are proposed, not implemented commands.

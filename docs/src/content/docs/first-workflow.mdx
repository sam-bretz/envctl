...
| `↑` `↓` | Move between runs |
| `←` `→` | Move between stages |
| `tab` | Cycle panels: Chat, Checkpoint, Changes, Tests, Decision Log |
| `i` | Steer the agent (this changes the work); `s` switches between worker and supervisor |

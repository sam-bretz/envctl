...
Named datasets with faster resets are milestone 2; see [Roadmap](/docs/roadmap/).

## Use a throwaway environment

```bash
envctl --feature scratch up
envctl --feature scratch down -v
```

The `--feature` flag overrides branch detection, so one branch can have several environments.
...
- [Agents](/docs/agents/) makes Claude Code worktrees do all of this automatically.
- [Troubleshooting](/docs/troubleshooting/) lists the errors you are most likely to meet.

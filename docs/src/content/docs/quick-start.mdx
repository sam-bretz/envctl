...
If envctl is not installed yet, see [Install](/docs/install/). Then, from the root of a repository that has a compose file:
...
```text
feature   fix-metergraph-capitalization
...
- [Concepts](/docs/concepts/) explains features, environments, and port modes.
- [How to work with envctl](/docs/how-to-work/) covers Makefiles, native test runners, and several branches at once.
- [Agents](/docs/agents/) wires Claude Code worktrees to environments.

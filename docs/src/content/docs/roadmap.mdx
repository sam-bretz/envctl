...
This is a delivery plan, not shipped functionality. The [workflow runtime plan](/envctl/design/workflow-runtime/) specifies architecture, contracts, proposed configuration, and research grounding. Milestones are acceptance-based; calendar estimates follow the runtime and harness spikes.

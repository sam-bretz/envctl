...
These adapters are available in the experimental version 2 workflow backend. Their component acceptance checks use real services in a local VM. Full milestone delivery remains tracked in the [roadmap](/docs/roadmap/).
